...
public class MapLauncher {
    ...
    ///   - cancelActionTitle: ActionSheet cancel action title, default value - "Cancel"
    ...
    private func buildActionSheet(for destination: CLLocationCoordinate2D) -> UIAlertController {
        ...
        // Add Cancel action
        actionSheetController.addAction(UIAlertAction(title: cancelActionTitle, style: .cancel, handler: nil))
